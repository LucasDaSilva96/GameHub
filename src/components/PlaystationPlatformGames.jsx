...
function PlaystationPlatformGames() {
  ...
  return (
    <React.Fragment>
      <h1 className="font-black text-3xl py-5 capitalize">Playstation</h1>
...
export default PlaystationPlatformGames;
