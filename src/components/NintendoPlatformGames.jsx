...
function NintendoPlatformGames() {
  ...
  const { error, data, isFetching } = useQuery({
    queryKey: ["Nintendo-Platform", page],
  ...
  return (
    <React.Fragment>
      <h1 className="font-black text-3xl py-5 capitalize">Nintendo</h1>
...
export default NintendoPlatformGames;
